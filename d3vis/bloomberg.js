...
var string = 'AAPL=AAPL&MSFT=MSFT&GOOG=GOOG&IBM=IBM&FB=FB&list=Last+Price';
...
val = val.split("") + "US Equity";
});

var raw_data = $.getJSON( "tickerdata.json", function(){
console.log("success");
});
